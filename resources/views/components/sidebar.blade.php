<div id="kt_aside" class="aside" data-kt-drawer="true" data-kt-drawer-name="aside"
    ...
    <div class="aside-toolbar flex-column-auto" id="kt_aside_toolbar">
        ...
        <div class="aside-user d-flex align-items-sm-center justify-content-center py-5">
            ...
            <img src="{{ asset('media/avatar.png') }}" alt="" style="max-width: 40%;" />
            {{-- </div> --}}
            <!--end::Symbol-->
            <!--begin::Wrapper-->
            <div class="aside-user-info flex-row-fluid flex-wrap ms-5">
                ...
                <div class="d-flex">
                    ...
                    <div class="flex-grow-1 me-2">
                        <!--begin::Username-->
                        <a href="#" class="text-white text-hover-primary fs-6 fw-bold">System Admin</a>
                        <!--end::Username-->
                    </div>
                    <!--end::Info-->
                    <!--begin::User menu-->
    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y px-2 my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div class="menu-item">
                    <a class="menu-link {{ in_array($curr_url,['dashboard'])?'active':'' }}"
                ...
                <div class="menu-item">
                    <a class="menu-link {{ in_array($curr_url,['prescription.index','prescription.view'])?'active':'' }}"
                ...
                <div class="menu-item">
                    <a class="menu-link {{ in_array($curr_url,['quotation.index','quotation.create'])?'active':'' }}"
                ...
                <div class="menu-item">
                    <a class="menu-link {{ in_array($curr_url,['notifications.index','notifications.edit','notifications.create'])?'active':'' }}"
